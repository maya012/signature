...
public class PaintBoard extends View {
    ...
    public String save() {
        ...
        try {
            File folder = new File(sdPath + "/Signature");
            if(!folder.isDirectory()){
                Log.d(TAG, "creating handwriting folder : " + folder);

                folder.mkdirs();
            }

            fileName = createFilename();
            fullFilePath = folder + "/" + fileName + ".png";
            FileOutputStream outstream = new FileOutputStream(fullFilePath);
            ...
            if (fileName != null) {
                Log.d(TAG, "file Name  " + fullFilePath);
